...
namespace DemoData
{
    ...
    vector<demo_t> DemoData::getDemos()
    {
        return demos;
    }

    demo_t DemoData::getDemoByName(string name)
    {
    ...
    demoHeader_t DemoData::getDemoHeaderByName(string name)
    {
        for(int i = 0; i < demos.size(); i++)
        {
            if(demos[i].name.compare(name) == 0)
    ...
    vector<tick_t> DemoData::getDemoTicksByName(string name)
    {
        for(int i = 0; i < demos.size(); i++)
        {
            if(demos[i].name.compare(name) == 0)
        ...
        cout << "not found!" << endl;
        return vector<tick_t>();
    }

    void DemoData::printInfo()
    {
        for(int i = 0; i < demos.size(); i++)
        {
    ...
    void DemoData::printBool(bool value)
    {
        if(value)
        {
            cout << "true";
    ...
    void DemoData::readDEMO(WADStructure::lumpInfo_t lump)
    {
